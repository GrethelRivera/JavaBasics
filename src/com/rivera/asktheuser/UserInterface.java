...
public class UserInterface {
    ...
    private static short askPokemonCardNumber() {
    ...
    private static int askNumberBattles() {  // separate method
    ...
    private static boolean askCompeteInternationally() {  // separate method
    ...
    private static long askCreditCard() {  // separate method
